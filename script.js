...
class Dialog extends React.Component {
  constructor(props) {
    super(props);
    _defineProperty(this, "handleDialogCallback", type => {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("dialog", {
      ...
      className: "content"
    }, /*#__PURE__*/React.createElement("h3", null, dialog && dialog.title), /*#__PURE__*/React.createElement("p", null, dialog && dialog.desc), /*#__PURE__*/React.createElement("div", {
      class: "btn-group"
...
class SessionContainer extends React.Component {
  constructor(props) {
    super(props);
    _defineProperty(this, "bulletItems", () => {
      const {
        sessionFocusCounter,
        selectedActiveMode
      } = this.props;
      ...
      for (let i = 0; i < 4; i++) {
        arr.push( /*#__PURE__*/React.createElement("div", {
          className: "session s show"
        }));
      }
      return arr;
    });
    _defineProperty(this, "bItems", focusCounter => {
      const {
        remainingTime,
        animationDuration,
        selectedActiveMode,
      ...
      const item = remainingTime === animationDuration ? "s" : remainingTime > animationDuration / 4 * 3 ? "s0" : remainingTime > animationDuration / 4 * 2 ? "s1" : remainingTime > animationDuration / 4 ? "s2" : 0 < remainingTime ? "s3" : "s4";
      const arr = [];
      ...
      for (let i = 0; i <= count; i++) {
        if (i !== count) {
          arr.push( /*#__PURE__*/React.createElement("div", {
            className: "session s4 show"
          }));
        } else {
          if (selectedActiveMode === "pomodoro") {
            arr.push( /*#__PURE__*/React.createElement("div", {
              className: `session ${item} show`
            }));
...
class Timer extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "killTimerProgress", () => {
      ...
      if (this.props.dialogReturn !== "stop") {
        if (this.state.sessionFocusCounter !== 0 || this.state.sessionShortBreakCounter !== 0 || this.state.sessionLongBreakCounter !== 0) {
          ...
          this.props.selectedActiveMode === "short break" ? this.lastSecondsSoundInterval = setTimeout(() => {
            breakDone.currentTime = 0;
            breakDone.play();
          }, 1000) : this.props.selectedActiveMode === "pomodoro" ? this.lastSecondsSoundInterval = setTimeout(() => {
    ...
    _defineProperty(this, "toggleTimerStart", type => {
      if (type && type === "stop") {
        if (this.props.dialogReturn === "stop") {
          this.setState({
    ...
    _defineProperty(this, "sessionCounter", type => {
      if (type === "short break") {
        this.setState({
    ...
    _defineProperty(this, "progressButtonOnClick", type => {
      if (this.state.timerStatusButtonTitle === "PAUSE") {
        this.setState({
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("section", {
      ...
      className: `timer ${isTimerRunning ? "start" : "pause"}`
    }, /*#__PURE__*/React.createElement("svg", {
    ...
    }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(SessionContainer, {
    ...
    }, /*#__PURE__*/React.createElement("span", null, mn), /*#__PURE__*/React.createElement("span", null, ":"), /*#__PURE__*/React.createElement("span", null, sc)), /*#__PURE__*/React.createElement("a", {
      id: "start_stop",
      href: "javascript:void(0)",
      onClick: () => {
        !isTimerOnProgress ? (this.toggleTimerStart("start"), buttonClick.currentTime = 0, buttonClick.play()) : isTimerRunning ? (this.toggleTimerStart("pause"), buttonClick.currentTime = 0, buttonClick.play()) : isTimerOnProgress && !isTimerRunning ? (this.toggleTimerStart("resume"), buttonClick.currentTime = 0, buttonClick.play()) : null;
      }
    }, timerStatusButtonTitle), isTimerRunning || isTimerOnProgress ? /*#__PURE__*/React.createElement("div", {
      className: "awe-container"
...
class SlideButtonItem extends React.Component {
  constructor(props) {
    super(props);
    _defineProperty(this, "switchMode", (mode, i, type) => {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, item.map((obj, i) => /*#__PURE__*/React.createElement("a", {
...
class SlideButtonContainer extends React.Component {
  constructor(props) {
    super(props);
    _defineProperty(this, "handleSelectedMode", childData => {
    ...
    _defineProperty(this, "handleSelectedButtonTopVal", childData => {
      this.setState({
        top: childData + "px"
      });
    });
    _defineProperty(this, "handleSelectedButtonWidthVal", childData => {
      this.setState({
        width: childData + "px"
      });
    });
    _defineProperty(this, "handleChildSlideItemSelection", childData => {
      this.setState({
        slideItemSelection: childData
      });
    });
    _defineProperty(this, "handleSelectedButtonTranslateX", childData => {
      this.setState({
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: this.props.isTimerRunning && "disabled"
    }, /*#__PURE__*/React.createElement("div", {
      className: "button-container"
    }, /*#__PURE__*/React.createElement(SlideButtonItem, {
      item: buttonList
...
class NumericInput extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: `item ${this.props.disabled && "disabled"}`
    ...
    }, this.state.value), /*#__PURE__*/React.createElement("a", {
      href: "javascript:void(0)",
      onClick: () => this.increase(this.props.name),
      id: isItBreakContent ? "break-increment" : "session-increment"
    })), /*#__PURE__*/React.createElement("p", {
      id: isItBreakContent ? "break-label" : "session-label"
    }, this.props.name), /*#__PURE__*/React.createElement("span", null, "-- on progress --"));
  }
}
...
class SettingsScreen extends React.Component {
  constructor(props) {
    super(props);
    _defineProperty(this, "handleSelectedTheme", childData => {
      this.setState({
        selectedTheme: childData
      }, () => {
    ...
    _defineProperty(this, "handleTime", (childName, childValue) => {
      const {
        timePomodoro,
        timeShort,
        timeLong
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      // themeDefault="green"
    }))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h4", null, "COLOR"), /*#__PURE__*/React.createElement(RadioContainer, {
      autoModeTheme: this.props.autoModeTheme,
    ...
    }), "\xA0\xA0back"), /*#__PURE__*/React.createElement("button", {
      className: "primary",
      id: "codepen",
      type: "button",
      onClick: () => {
        window.open('https://codepen.io/badeozgule', '_blank');
      }
    }, /*#__PURE__*/React.createElement("i", {
...
class App extends React.Component {
  constructor(props) {
    super(props);
    _defineProperty(this, "resizeListener", () => {
      this.setState({
        isResizeActive: true
      });
      clearTimeout(this.resizeTimeout);
    ...
    _defineProperty(this, "toggleSettingsScreen", childData => {
      this.setState({
    ...
    _defineProperty(this, "handleSelectedActiveMode", childData => {
      const {
        selectedActiveMode,
    ...
    _defineProperty(this, "handleTimerData", (childPomodoroData, childShortData, childLongData) => {
      this.setState({
    ...
    _defineProperty(this, "handleDialogCallback", (childData, childType) => {
      if (childData) {
    ...
    _defineProperty(this, "handleDialogReturnResult", childData => {
      this.setState({
        dialogReturn: childData
      });
    });
    _defineProperty(this, "handleIsTimerRunning", childData => {
      this.setState({
        isTimerRunning: childData
      });
    });
    _defineProperty(this, "handleIsTimerOnProgress", childData => {
      this.setState({
        isTimerOnProgress: childData
      });
    });
    _defineProperty(this, "handleFocusSessionCounter", childData => {
      this.setState({
        sessionFocusCounter: childData
      });
    });
    _defineProperty(this, "handleParentSlideItemSelection", childData => {
      this.setState({
        slideItemSelection: childData
      });
    });
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("main", {
      className: `${isAutoModeThemeActive ? "theme-auto theme-" + selectedTheme : "theme-" + selectedTheme} ${isResizeActive ? "resize-animation-stopper" : ""}`
    }, /*#__PURE__*/React.createElement(GithubCorner, {
      url: "https://github.com/badeozgule/react-pomodoro-app"
    }), /*#__PURE__*/React.createElement("div", {
      className: this.state.isSettingsOpen ? "hidden" : null
    }, /*#__PURE__*/React.createElement("section", {
      align: "left"
    }, /*#__PURE__*/React.createElement("h1", {
      id: "timer-label"
    }, "pomodoro App"), /*#__PURE__*/React.createElement("p", null, "Plan your work and stay productive")), /*#__PURE__*/React.createElement(Timer, {
      ...
      class: "controller"
    }, /*#__PURE__*/React.createElement(SlideButtonContainer, {
    ...
    }, " Bade Ozgule")))), /*#__PURE__*/React.createElement(SettingsScreen, {
